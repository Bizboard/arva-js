...
$__System.register("1", ["2"], function (_export, _context) {
    ...
    var firebase, _classCallCheck, _createClass, refs, firebaseApp, FirebaseWorker;
    ...
    return {
        ...
        execute: function () {
            ...
            FirebaseWorker = function () {
                function FirebaseWorker() {
                    _classCallCheck(this, FirebaseWorker);
                }

                _createClass(FirebaseWorker, null, [{
                    key: 'onMessage',
                    value: function onMessage(event) {
                        var options = JSON.parse(event.data[0]);
                    ...
                    value: function subscribe() {
                        ...
                        refs[options.clientID].queryRef.on(options.event, function (snapshot) {
                            var prevSiblingId = arguments.length <= 1 || arguments[1] === undefined ? undefined : arguments[1];
                    ...
                    value: function value() {
                        ...
                        refs[options.clientID].queryRef.once('value', function (snapshot) {
                            var prevSiblingId = arguments.length <= 1 || arguments[1] === undefined ? undefined : arguments[1];
                    ...
                    key: 'setWithPriority',
                    value: function setWithPriority() {
                        var options = arguments.length <= 0 || arguments[0] === undefined ? {} : arguments[0];
